...
public class TouchInterceptor extends ListView {
     ...
     */
    private static int mDragPos;
    /**
     * At which position was the item being dragged originally
     */
    private static int mSrcDragPos;
    private static int mDragPointX; // at what x offset inside the item did the
    // user grab it
    private static int mDragPointY; // at what y offset inside the item did the
    // user grab it
    private static int mXOffset; // the difference between screen coordinates
    // and coordinates in this view
    private static int mYOffset; // the difference between screen coordinates
    private static int mUpperBound;
    private static int mLowerBound;
    private static int mHeight;
    private static int mRemoveMode = -1;
    private static int mItemHeightNormal;
    private static int mItemHeightExpanded;
    private static int mItemHeightHalf;
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    // item
                    if (x < dipToPixels(getContext(), 60)) {
    ...
    public void setCenterGravity(boolean bool) {
        mCenter = bool;
    }
