 ...
 * next track buttons.
 */
public class MediaAppWidgetProvider4x4_Light extends AppWidgetProvider {
    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate4x4";
    private static MediaAppWidgetProvider4x4_Light sInstance;

    public static synchronized MediaAppWidgetProvider4x4_Light getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider4x4_Light();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MediaPlaybackService.CMDNAME,
                MediaAppWidgetProvider4x4_Light.CMDAPPWIDGETUPDATE);
    ...
    public void performUpdate(MediaPlaybackService service, int[] appWidgetIds) {
        ...
        if (errorState != null) {
            ...
            views.setTextViewText(R.id.albumname, albumName + "-" + artistName);
        ...
        switch (service.getRepeatMode()) {
            ...
            case MediaPlaybackService.REPEAT_CURRENT:
                views.setImageViewResource(R.id.control_repeat,
                        R.drawable.ic_mp_repeat_once_btn_black);
                break;
            default:
                views.setImageViewResource(R.id.control_repeat,
