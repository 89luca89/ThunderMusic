 ...
 * next track buttons.
 */
public class MediaAppWidgetProvider2x1 extends AppWidgetProvider {
    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate";
    private static MediaAppWidgetProvider2x1 sInstance;

    public static synchronized MediaAppWidgetProvider2x1 getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider2x1();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MediaPlaybackService.CMDNAME,
                MediaAppWidgetProvider2x1.CMDAPPWIDGETUPDATE);
