 ...
 * next track buttons.
 */
public class MediaAppWidgetProvider4x4 extends AppWidgetProvider {
    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate4x4";
    private static MediaAppWidgetProvider4x4 sInstance;

    public static synchronized MediaAppWidgetProvider4x4 getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider4x4();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MediaPlaybackService.CMDNAME,
                MediaAppWidgetProvider4x4.CMDAPPWIDGETUPDATE);
