 ...
 * next track buttons.
 */
public class MediaAppWidgetProvider4x1_Light extends AppWidgetProvider {
    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate";
    private static MediaAppWidgetProvider4x1_Light sInstance;

    public static synchronized MediaAppWidgetProvider4x1_Light getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider4x1_Light();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MediaPlaybackService.CMDNAME,
                MediaAppWidgetProvider4x1_Light.CMDAPPWIDGETUPDATE);
