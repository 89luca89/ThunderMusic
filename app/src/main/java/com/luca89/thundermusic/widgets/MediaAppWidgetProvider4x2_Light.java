 ...
 * next track buttons.
 */
public class MediaAppWidgetProvider4x2_Light extends AppWidgetProvider {
    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate4x2";
    private static MediaAppWidgetProvider4x2_Light sInstance;

    public static synchronized MediaAppWidgetProvider4x2_Light getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider4x2_Light();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        updateIntent.putExtra(MediaPlaybackService.CMDNAME,
                MediaAppWidgetProvider4x2_Light.CMDAPPWIDGETUPDATE);
